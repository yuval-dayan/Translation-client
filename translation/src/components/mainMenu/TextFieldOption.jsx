...
const TextFieldOption = ({ textInput, setTextInput, setValueToPresent, setValues, setOptions, options, setOtherOption,isOther,setIsOther }) => {
        ...
        <div className='other-translation'>
            <div className='other-translation-new-word'>
                <TextField fullWidth onChange={handleTextInputChange} onKeyPress={onkeyPress}
                    ...
                    id="standard-basic" variant="standard" ref={ref} onClick={handleClick}     inputRef={(input) => {
                      handleClickInput(input)
                      }} />
            </div>
            <div>
